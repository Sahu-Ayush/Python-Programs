...
Write a function to search this element in the given input array/list using 'Binary Search'. Return the index of the element in the input array/list.
...
'''
def binarySearchIterative(arr, n, data):
    low = 0
    high = n - 1
    while low <= high:
        mid = low + (high - low) // 2
...
data = int(input())
print(binarySearchIterative(arr, num_ele, data))
'''
...
while t > 0:
    ...
    print(binarySearchIterative(arr, n, data))
    t -= 1
